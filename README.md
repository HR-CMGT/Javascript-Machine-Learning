...
- [Using KNN to create a simple recommender system](https://github.com/HR-CMGT/PRG08-2022-2023/tree/main/week5/recommender), or [create a Movie Recommender System](https://github.com/javascript-machine-learning/movielens-recommender-system-javascript) and a [Image recommender system](https://dev.to/jimatjibba/build-a-content-based-recommendation-engine-in-js-2lpi)
